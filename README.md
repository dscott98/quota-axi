...
| Flag                               | Description                                                               |
| ---------------------------------- | ------------------------------------------------------------------------- |
| `--provider <id,...>`              | Scope providers; `--help` lists all selectable IDs                        |
...
| Cursor, GitHub Copilot, Kimi, Z.AI, Alibaba, OpenCode Go, Antigravity, Command Code, MiniMax | none                              | read-only; see the per-provider notes below           |
